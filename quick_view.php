...
if (isset($_GET['pid'])) {
    $pid = $_GET['pid'];
    // Validate $pid to ensure it's a valid integer
            ...
            <form action="" method="post" class="box">
                ...
                <div class="row">
                    ...
                    <div class="content">
                        ...
                        <div class="flex">
                            <div class="price"><span></span><?= htmlspecialchars($fetch_product['price']); ?>DH<span></span></div>
...
<?php
        ...
        echo '<p class="empty">No product found with ID ' . htmlspecialchars($pid) . '</p>';
    }
} else {
