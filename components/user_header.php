...
<header class="header">
   <section class="flex">
      ...
      <a href="home.php" class="logo">ParaMedical</a>
      <nav class="navbar">
      <a href="home.php"><i class="fas fa-home"></i> Home</a>
      <a href="shop.php"><i class="fas fa-store"></i> Shop Now</a>
      <a href="orders.php"><i class="fas fa-file-invoice-dollar"></i> Commandes</a>
